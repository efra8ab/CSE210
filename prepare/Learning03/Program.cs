...
class Program
{
    ...
    {
        Fraction fraction_no = new Fraction();
        Console.WriteLine(fraction_no.GetFractionString());
        Console.WriteLine(fraction_no.GetDecimalValue());
        
        Fraction fraction_1 = new Fraction(5);
        ...
        Fraction fraction_3 = new Fraction(1,3);
